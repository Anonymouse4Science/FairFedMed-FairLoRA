...
def main(args):
    ...
    for epoch in range(start_epoch, max_epoch):
        ...
        if args.trainer == 'CLIP':
            ...
            # Important!!
            print('Use EMA')
            global_weights = average_weights_EMA(global_weights, local_weights, idxs_users, datanumber_client, datanumber_client_by_attr, epoch, max_epoch)
