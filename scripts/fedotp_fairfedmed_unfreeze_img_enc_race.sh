...
do
  ...
  do
    for SEED in 1
    do
      DIR=output/${DATASET}_${PARTITION}_beta${BETA}_normalize_unfreeze_image_enc${UNFREEZE_IMAGE_ENC}_ln_pre/${MODEL}_${TRAINER}_${OT}_${TOP_PERCENT}_eps${EPS}_${ATTRIBUTE_TYPE}/nctx${NCTX}_csc${CSC}_ctp${CTP}/iid_${IID}_${USERS}users_${FRAC}frac_lr${LR}_${ROUND}round_seed${SEED}
      if [ -d "$DIR" ]; then
